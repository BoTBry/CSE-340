...
import { showCategoriesPage, showCategoryDetailsPage, showProjectDetailsPageById } from './controller/categories.js';
...
router.get('/service/:id', showProjectDetailsPageById);
